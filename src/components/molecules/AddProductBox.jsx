  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-10 gap-5'>
      <div className="img-product lg:col-span-3 font-medium">
        <div className="border rounded-lg shadow-sm pb-4">
      ...
      <div className="desc-product lg:col-span-7 shadow-sm rounded-lg border font-medium">
        ...
        <div className="form-product-information p-5">
          ...
          <div className="product-price grid md:grid-cols-3 gap-3 mb-3">
            ...
            <InputBox title={'Harga Diskon'} optional={'Optional'} placeholder={'Masukan harga diskon'}/>
          </div>
          <div className="stock w-[200px] md:w-[300px] mb-3"><InputBox title={'Atur Stok'} placeholder={'Atur stok barang'}/></div>
          <TextBox />
