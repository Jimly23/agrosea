...
const SidebarDetailPrice = ({productId, productImage, productName, priceAfterDiscount}) => {
  ...
  const priceSubTotal = subTotal.toLocaleString('id-ID', {
    style: 'currency',
    currency: 'IDR',
  ...
  return (
    <div className="sidebar-detail-price col-span-12 lg:col-span-3 w-full">
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-5'>
        {/* card store */}
        <CardStore />

        <div className='h-[290px] border border-slate-300 shadow-sm rounded-lg p-3'>
