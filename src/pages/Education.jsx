...
const Education = () => {
  ...
  const handleNavigate = (img,title) => {
    ...
    <>
      ...
      <main className='max-w-[1280px] mx-auto mb-[200px] px-5 xl:px-0'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div onClick={()=>handleNavigate(trending1,'Panduan Lengkap Menanam Padi dengan Hasil Melimpah dan Berkualitas')} className="w-full h-[550px] relative overflow-hidden cursor-pointer">
          ...
          <div className="w-full h-[550px] grid grid-rows-2 gap-2">
            <div onClick={()=>handleNavigate(trending2,'Teknik Modern Menangkap Tuna')} className="w-full h-full relative overflow-hidden cursor-pointer">
            ...
            <div onClick={()=>handleNavigate(trending3,'Rahasia Menanam Jagung : Teknik untuk Hasil Maksimal dan Berkualitas')} className="w-full h-full relative overflow-hidden cursor-pointer">
